...
class RentHouseForm extends StatefulWidget {
  const RentHouseForm({Key? key}) : super(key: key);

  @override
  State<RentHouseForm> createState() => RentHouseFormState();
}

class RentHouseFormState extends State<RentHouseForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color(0xFFAD2524), // Custom background color for app bar
        title: const Text('Rent House Registration Form'),
        leading: IconButton(
